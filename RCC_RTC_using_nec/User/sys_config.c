  ...
  * @version      V0.1.1
  * @date         2025-05-1
  * @brief       This file contains the system configuration functions.
  * @attention This file is for STM32F10x devices.
  *              
  ******************************************************************************
  * @details     This file contains the system configuration functions. It includes the following functions:
  *             - RCC_Configuration: Configures the system clock (RCC).
  *             - EXTI_Key_Config: Configures the EXTI and NVIC for encoders and buttons.
  *             - EXTI_NEC_Config: Configures the EXTI and NVIC for NEC protocol.
  * @changelog
  * ------------v0.0.1  RCC时钟配置、按键中断、NEC协议中断配置、GPIOPA_PC复用配置   2025-05-02
  *
 ...
 * @attention It also configures the GPIO ports for the buttons and encoders.
 */
void EXTI_NEC_Config() /* 主要是连接EXTI与GPIO */
{
	//GPIO端口配置
    GPIO_InitTypeDef GPIO_InitStruct ;
    /* 初始化要与EXTI连接的GPIO */
...
/**
  * @brief 设置 PA 13, 14, 15 和 PC 13, 14, 15 为 IO 功能
  * @param  None
  * @retval None
  * @note 关闭外部低速时钟和入侵检测功能以允许使用 PC13, PC14, PC15 作为普通 IO
  */
