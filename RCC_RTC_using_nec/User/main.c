...
int main(void)
{
	...
	Display_Lcd_1602(1,1,(u8*)"2023-12-07 Thur.",16); 	
  	Display_Lcd_1602(2,1,(u8*)"  00:00:00      ",16);	
	while(1)
	{
		if(setting_mode == normal)
			{       
				...
				switch(rweek) 
				{
					case 0:Display_Lcd_1602(1,12,(u8*)"Sun. ",16);  break;
					case 1:Display_Lcd_1602(1,12,(u8*)"Mon. ",16);  break;
					case 2:Display_Lcd_1602(1,12,(u8*)"Tues.",16);  break;
					case 3:Display_Lcd_1602(1,12,(u8*)"Wed. ",16);  break;
					case 4:Display_Lcd_1602(1,12,(u8*)"Thur.",16);  break;
					case 5:Display_Lcd_1602(1,12,(u8*)"Fri. ",16);  break;
					case 6:Display_Lcd_1602(1,12,(u8*)"Sat. ",16);  break;
