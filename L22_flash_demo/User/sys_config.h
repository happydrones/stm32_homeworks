...
#include "stm32f10x.h"	 
#define KEY_EXIT_RCC                RCC_APB2Periph_AFIO	

#define KEY_UP_EXTI_IRQN  			EXTI0_IRQn
#define KEY_UP_EXTI_GPIO_RCC  		RCC_APB2Periph_GPIOC
...
#define KEY_DOWN_EXTI_GPIO_RCC  	RCC_APB2Periph_GPIOC
#define KEY_DOWN_EXTI_GPIO_PIN   	GPIO_Pin_3
#define KEY_DOWN_EXTI_LINE          EXTI_Line3
#define KEY_UP_SOURCE  		        GPIO_PortSourceGPIOC
