...
void I2C_Sand_Buffer(u8 SlaveAddr,u8 WriteAddr,u8* pBuffer,u16 NumByteToWrite)
{
	...
	while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_MODE_SELECT)); //等待单片机占据总线。获得EV5
	I2C_Send7bitAddress(I2C1,SlaveAddr,I2C_Direction_Transmitter);//发送器件地址
	while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));//等待主机发送完成从机地址清除EV6
