/**
 * @file main.c
 * @brief This file was uesd to practise using systick as the time source to achieve the delay
 * 
 * 
 * @note
 * 
...
int main(void)
{
    ...
    // 3. 配置 MCO 输出为系统时钟（SYSCLK）
    RCC_MCOConfig(RCC_MCO_PLLCLK_Div2); // 可选择 RCC_MCO_HSI、RCC_MCO_HSE、RCC_MCO_PLLCLK_Div2 等
