...
//频率：PWM_f   1-10000 Hz     PWM_Duty :1-100   Breathing_Linght_Speet  呼吸速度   80hz频率，周期12.5ms
void GPIO_Out_PWM_Breathing_Linght(GPIO_TypeDef* GPIOx,uint16_t GPIO_Pin,u8 Breathing_Linght_Speet ,u16 PWM_f,u16 PWM_Duty)
{  
	 u8 PWM_Resolution =100;  //分辨率 100
	 u16 PWM_Low =0;          //PWM低电平宽度 局部变量
	 u16 T_Num = 0;           //对应频率周期需要多少个us级延迟函数调用 局部变量
