...
void I2C_Send_Byte(u8 txd)
{
    ...
    for(t=0;t<8;t++)
    {
        ...
        txd<<=1;
        Delay_us(5);
        GPIO_SetBits(I2C_PORT,PIN_SCL);  	//            _____ 
        Delay_us(5);                     	// CLK  _____|     |_____
        GPIO_ResetBits(I2C_PORT,PIN_SCL);	//        5us   5us   5us
        Delay_us(5);
    }
}
...
void SingleWrite(u8 device_addr,u8 addr,u8 data)
{
    I2C_Start();
