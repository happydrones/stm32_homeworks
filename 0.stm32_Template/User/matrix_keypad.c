...
/**
  * @brief  Initializes the GPIO ports  without using intrrupt for the keypad rows and columns.
...
/**
  * @brief  Initializes the GPIO ports with using intrrupt for the keypad rows and columns.
  */
